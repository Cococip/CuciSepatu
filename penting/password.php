...
if (isset($_POST['password_ubah'])) {
    ...
    $row = $db->query("SELECT * FROM user WHERE username='{$_SESSION['login']}' AND password='".md5($pass1)."'")->fetch_assoc();
    if ($pass1 == '' || $pass2 == '' || $pass3 == '') {
        ...
        $db->query("UPDATE user SET password='".md5($pass2)."' WHERE username='{$_SESSION['login']}'");
