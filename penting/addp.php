...
if (isset($_POST['proses'])) {
    ...
    if (mysqli_query($con, $query)) {
        mysqli_close($con);
        echo "<script>alert('Data berhasil ditambahkan!'); window.location.href='pesanan.php';</script>";
    } else {
        mysqli_close($con);
        echo "<script>alert('Data gagal ditambahkan!'); window.location.href='tambahpesanan.php';</script>";
    }
}
?>
